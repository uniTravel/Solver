...
/// <summary>网络规划问题的解
/// </summary>
/// <typeparam name="Optimal">最优解。</typeparam>
...
module Subject =
    ...
    /// <para>4、上界字典中的弧，须为成本字典中弧的真子集。</para>
    /// <para>5、根节点没有弧相连。</para>
    /// <para>6、除根节点之外的图为连通图。</para>
    /// </remarks>
    ...
    val internal value: sub: T -> int[] * int[][] * int[][] * IDictionary<int * int, int> * IDictionary<int * int, int>
