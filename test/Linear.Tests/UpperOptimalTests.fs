module Solver.Linear.Tests.Upper.Optimal
...
let private solve = Upper.solve Upper.optimal Row.trans
let private asolve = Upper.solve Upper.optimal Row.atrans
    ...
    testList
        ...
        [ testCase "同步算法"
          ...
          <| fun _ ->
              ...
              Expect.sequenceEqual p.Values [ ref false; ref true; ref false ] "上界解指示器错误。"
              validate a l pe le ]
    |> testLabel "Linear.Upper.Optimal"
...
let test2 =
    ...
    let pe: float[,] =
        array2D [ [ 22; 1; 0; 0; 0; 1 ]; [ 8; 1; 2; 0; 1; -2 ]; [ 1; 0; -0.5; 1; 0; 0.5 ] ]
