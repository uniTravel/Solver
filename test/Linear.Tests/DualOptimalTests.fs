module Solver.Linear.Tests.Dual.Optimal
...
let private solve = Dual.solve Dual.optimal Row.trans
let private asolve = Dual.solve Dual.optimal Row.atrans
