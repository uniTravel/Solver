module Solver.Linear.Tests.Primal.Classic
...
let private solve = Primal.solve Primal.classic Row.trans
let private asolve = Primal.solve Primal.classic Row.atrans
    ...
    testList
        ...
        [ testCase "同步算法"
          ...
          <| fun _ ->
              ...
              let a, l = result[0]
              validate a l pe le ]
    |> testLabel "Linear.Primal.Classic"
